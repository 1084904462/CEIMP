...
public class TextMapUtil {
    ...
    public Map<String,String> get(BasicScholarshipBean bean){
        Map<String,String> textMap = new HashMap<>(70);
        String identity = bean.getIdentity().trim();
        ...
        textMap.put("ts",bean.getTimeStart().toString().trim());
        textMap.put("te",bean.getTimeEnd().toString().trim());
        textMap.put("school",bean.getSchool().trim());
        textMap.put("major",bean.getMajor().trim());
        textMap.put("classNum",bean.getClassNum().trim());
        textMap.put("username",bean.getUsername().trim());
        textMap.put("sex",bean.getSex().trim());
        textMap.put("account",bean.getAccount().trim());
        textMap.put("birth",bean.getBirth().trim());
        textMap.put("entrance",bean.getEntrance().trim());
        textMap.put("phone",bean.getPhone().trim());
        textMap.put("nation",bean.getNation().trim());
        textMap.put("political",bean.getPolitical().trim());
        textMap.put("job",bean.getJob().trim());
        textMap.put("charact",bean.getCharact().trim());
        textMap.put("study",bean.getStudy().trim());
        textMap.put("ability",bean.getAbility().trim());
        textMap.put("total",bean.getTotal().trim());
        textMap.put("ceRank",bean.getCeRank().trim());
        textMap.put("gpRank",bean.getGpRank().trim());
        textMap.put("majorSum",bean.getMajorSum().trim());
        textMap.put("resident",bean.getResident().trim());
        textMap.put("incomeSource",bean.getIncomeSource().trim());
        textMap.put("monthIncome",bean.getMonthIncome().trim());
        textMap.put("familySum",bean.getFamilySum().trim());
        textMap.put("address",bean.getAddress().trim());
        textMap.put("postalCode",bean.getPostalCode().trim());
        textMap.put("situation",bean.getSituation().trim());
        textMap.put("classSum",bean.getClassSum().trim());
        textMap.put("passSum",bean.getPassSum().trim());
        textMap.put("fName1",bean.getfName1().trim());
        textMap.put("age1",bean.getAge1().trim());
        textMap.put("relation1",bean.getRelation1().trim());
        textMap.put("workPlace1",bean.getWorkPlace1().trim());
        textMap.put("fName2",bean.getfName2().trim());
        textMap.put("age2",bean.getAge2().trim());
        textMap.put("relation2",bean.getRelation2().trim());
        textMap.put("workPlace2",bean.getWorkPlace2().trim());
        textMap.put("fName3",bean.getfName3().trim());
        textMap.put("age3",bean.getAge3().trim());
        textMap.put("relation3",bean.getRelation3().trim());
        textMap.put("workPlace3",bean.getWorkPlace3().trim());
        textMap.put("fName4",bean.getfName4().trim());
        textMap.put("age4",bean.getAge4().trim());
        textMap.put("relation4",bean.getRelation4().trim());
        textMap.put("workPlace4",bean.getWorkPlace4().trim());
        textMap.put("fName5",bean.getfName5().trim());
        textMap.put("age5",bean.getAge5().trim());
        textMap.put("relation5",bean.getRelation5().trim());
        textMap.put("workPlace5",bean.getWorkPlace5().trim());
        textMap.put("date1",bean.getDate1().trim());
        textMap.put("award1",bean.getAward1().trim());
        textMap.put("unit1",bean.getUnit1().trim());
        textMap.put("date2",bean.getDate2().trim());
        textMap.put("award2",bean.getAward2().trim());
        textMap.put("unit2",bean.getUnit2().trim());
        textMap.put("date3",bean.getDate3().trim());
        textMap.put("award3",bean.getAward3().trim());
        textMap.put("unit3",bean.getUnit3().trim());
        textMap.put("date4",bean.getDate4().trim());
        textMap.put("award4",bean.getAward4().trim());
        textMap.put("unit4",bean.getUnit4().trim());
        textMap.put("applyReason",bean.getApplyReason().trim());
        textMap.put("recommendReason",bean.getRecommendReason().trim());
        textMap.put("rank",bean.getRank().trim());
        textMap.put("opinion",bean.getOpinion().trim());
        return textMap;
    }

    public List<Map<String,String>> getList(List<BasicScholarshipBean> list){
        List<Map<String,String>> mapList = new ArrayList<>();
        for(int i=0;i<list.size();i++){
            mapList.add(this.get(list.get(i)));
        }
        return mapList;
    }
